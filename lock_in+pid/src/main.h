...
#define PARAMS_NUM        223 // Andi: added +2
...
#define LOCK_GEN_MOD_SQP2               221 // Andi: added
// other parameters added by Andi
#define LED_STATE                       222 // Andi: added
// [MAINDEFH DOCK END]

// Andi: added parameters
#define FS                              125e6                   // clock frequency
#define FTW_WIDTH                       27                      // frequency tuning bits
#define LOCK_GEN_MOD_FRES               (FS/(1<<(FTW_WIDTH+1))) // frequency resolution
#define LOCK_GEN_MOD_PRES               (360.0/(1<<14))         // phase resolution
...
// other parameters added by Andi (only LED at the moment)
#define PARAMS_OTHER                    222
