...
#define LOCK_BASE_SIZE 0x200    // Andi: 0x190 is too small even without my added register! 
                                // but mmap maps in pages (4096 returned by getpagesize())
...
typedef struct lock_reg_t {
    ...
    /** @brief Offset 20'h000A4 - gen_mod_sqp
      *  square signal modulation frequency tuning word
      *
      *  bits [31: 0] - Data
      */
    ...
    /** @brief Offset 20'h001BC - gen_mod_sqp2
      *  square signal demodulation frequency tuning word
      *
      *  bits [31: 0] - Data
      */
    uint32_t gen_mod_sqp2; // added by Andi
